...
defaultRoute = {
  ...
  handler: function(arg$){
    var method, pathname, headers, app, config, notFound, filename, _response;
    method = arg$.method, pathname = arg$.pathname, headers = arg$.headers, app = arg$.app;
    config = app.config;
    notFound = function(){
...
module.exports = createApp = function(){
  ...
  pushRoute = reverseRoute = matchRoute = null;
  ...
  app.executeHandler = function(req, arg$){
    var handler, module, action, params;
    handler = arg$.handler, module = arg$.module, action = arg$.action, params = arg$.params;
    req.module = module;
    req.action = action;
    return Q.fcall(handler, req, params);
  };
  app.initModules = function(modules){
    ...
    return pushRoute = matchRoute.pushRoute, reverseRoute = matchRoute.reverseRoute, matchRoute;
  };
