...
var STATUS_CODES, fs, path, EventEmitter, Q, mime, router, respond, configStore, patchIncomingRequest, statelessSwig, discoverControllers, localizedContent, services, HTTP_VERBS, defaultRoute, defaultErrorHandler, defaultHeartbeatHandler, mapResult, sendTo, createApp, toString$ = {}.toString;
