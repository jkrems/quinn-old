...
var STATUS_CODES, fs, path, EventEmitter, Q, mime, router, respond, config, patchIncomingRequest, HTTP_VERBS, defaultRoute, defaultErrorHandler, defaultHeartbeatHandler, mapResult, sendTo, createApp, toString$ = {}.toString;
...
defaultRoute = {
  ...
  handler: function(arg$){
    var method, pathname, headers, notFound, filename, _response;
    method = arg$.method, pathname = arg$.pathname, headers = arg$.headers;
    notFound = function(){
