...
var target, COMMENTS_PATTERN, ARGS_PATTERN, ARG_PATTERN, targetFromFn, parseTarget, requestContext, action, inject, toString$ = {}.toString, slice$ = [].slice;
  ...
  Object.defineProperties(ctx, {
    page: {
      get: function(){
        ...
        return pageModel(req);
      }
    },
    render: {
      get: function(){
        var render, defaultTemplate;
        render = require('./render');
        defaultTemplate = req.action === 'index'
          ? req.module
          : req.module + "/" + req.action;
        return function(tplName, tplCtx, tplOps){
          var ref$, tplOpts;
          ...
          return render(tplName, tplCtx, tplOpts);
        };
      }
    }
  });
