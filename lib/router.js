...
var Url, compileRoute, isEqual, map, reduce, addSegmentAccessor, createRoute, ANY, router, ref$, toString$ = {}.toString, slice$ = [].slice;
Url = require('url');
...
ANY = ['ANY'];
module.exports = router = function(controller){
