...
var compileRoute, addSegmentAccessor, createRoute, ANY, router, ref$, toString$ = {}.toString, slice$ = [].slice;
...
module.exports = router = function(){
  ...
  matchRoute = function(arg$){
    var method, pathname, routesToTry, ref$, i$, len$, pattern, handler, accessors, params, matched, segmentMatches;
