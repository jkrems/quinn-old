...
module.exports = bootServer = function(appRoot){
  var quinn, e, controller, createApp, config, routes, serverInit, moduleBase, modules, foundControllers, app, server, port;
  quinn = (function(){
    try {
  ...
  controller = quinn.controller, createApp = quinn.createApp, config = quinn.config;
