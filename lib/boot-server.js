...
module.exports = bootServer = function(appRoot){
  var quinn, e, controller, createApp, config, render, routes, serverInit, moduleBase, modules, foundControllers, foundTemplates, app, server, port;
  quinn = (function(){
    try {
  ...
  controller = quinn.controller, createApp = quinn.createApp, config = quinn.config, render = quinn.render;
